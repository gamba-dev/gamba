...
__all__ = ['check_measure_data', 'duration', 'frequency', 'number_of_bets', 'mean_bets_per_day', 'intensity',
           'frequency_raw', 'total_wagered', 'mean_bet_size', 'variability', 'trajectory', 'net_loss', 'percent_loss',
           'theoretical_loss', 'calculate_labrie_measures', 'calculate_braverman_measures',
           'standardise_measures_table', 'split_measures_table']
